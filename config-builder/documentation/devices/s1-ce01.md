...
| Vlan2001 | vrf-bkp-xco-site01 | BKP | - | False |

##### IPv4

| Interface | VRF | IP Address | IP Address Virtual | IP Router Virtual Address | ACL In | ACL Out |
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan1810 |  FW-HA  |  10.18.10.{{ device_id }}/24  |  -  |  -  |  -  |  -  |
| Vlan2001 |  BKP  |  10.200.1.{{ device_id }}/24  |  -  |  -  |  -  |  -  |
...
interface Vlan1810
   ...
   no shutdown
   vrf FW-HA
   ip address 10.18.10.{{ device_id }}/24
...
interface Vlan2001
   ...
   no shutdown
   vrf BKP
   ip address 10.200.1.{{ device_id }}/24
```

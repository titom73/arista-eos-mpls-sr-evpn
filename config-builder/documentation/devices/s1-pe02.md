...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.2.12/24 | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | ROUTER_s1-ce02_eth1 | trunk | 1018 | - | - | - |
...
!
interface Ethernet4
   description ROUTER_s1-ce02_eth1
   no shutdown
...
| Loopback1810 | Test loopback | SVC01_VRF01 | 10.18.0.2/32 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 1811 | 10.255.1.2:11811 | 11811:11811 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| SVC01_VRF01 | 10.255.1.2:10 | connected |

...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.2.14/24 | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | ROUTER_s1-ce04_eth1 | trunk | 1018 | - | - | - |
...
| Loopback1810 | Test loopback | SVC01_VRF01 | 10.18.0.4/32 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 1811 | 10.255.1.4:11811 | 11811:11811 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| SVC01_VRF01 | 10.255.1.4:10 | connected |

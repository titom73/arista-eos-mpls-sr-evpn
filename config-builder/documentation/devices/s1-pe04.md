...
| Loopback1011 | SVC_ETHERNET_LOOPBACK | ETHERNET_VPN | 10.1.255.4/32 |
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan1114 | SVC01_C1_VLAN_SITE01_PE04 | ETHERNET_VPN | - | False |

##### IPv4

| Interface | VRF | IP Address | IP Address Virtual | IP Router Virtual Address | ACL In | ACL Out |
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan1114 |  ETHERNET_VPN  |  -  |  10.1.4.1/24  |  -  |  -  |  -  |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 1114 | 10.255.1.4:11114 | 11114:11114 | - | - | learned |
...
| ETHERNET_VPN | 10.255.1.4:11 | connected |

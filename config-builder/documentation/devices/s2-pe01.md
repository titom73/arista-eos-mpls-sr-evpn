...
| ------- | ---- | ------------ |
| 1015 | SVC01_C1_VLAN_SITE02_PE01 | - |
...
| Loopback1001 | SVC_ETHERNET_LOOPBACK | ETHERNET_VPN | 10.1.255.5/32 |
...
| Loopback1001 | SVC_ETHERNET_LOOPBACK | ETHERNET_VPN | - |
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan1015 | SVC01_C1_VLAN_SITE02_PE01 | ETHERNET_VPN | - | False |

##### IPv4

| Interface | VRF | IP Address | IP Address Virtual | IP Router Virtual Address | ACL In | ACL Out |
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan1015 |  ETHERNET_VPN  |  -  |  10.1.5.1/24  |  -  |  -  |  -  |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 1015 | 10.255.1.5:11015 | 11015:11015 | - | - | learned |

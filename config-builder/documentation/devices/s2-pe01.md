...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 192.168.2.21/24 | 192.168.2.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | ROUTER_s2-ce01_eth1 | trunk | 1-4094 | - | - | - |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_s2-p01_Ethernet1 | - | 10.255.3.16/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_s2-p02_Ethernet1 | - | 10.255.3.18/31 | default | 1500 | False | - | - |
...
| Loopback1011 | SVC_ETHERNET_LOOPBACK | ETHERNET_VPN | 10.1.255.5/32 |
| Loopback1012 | SVC_ETHERNET_LOOPBACK | ATM | 10.2.255.5/32 |
...
| Loopback1011 | SVC_ETHERNET_LOOPBACK | ETHERNET_VPN | - |
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan1115 | SVC01_C1_VLAN_SITE02_PE01 | ETHERNET_VPN | - | False |
| Vlan1205 | L3VPN-EXIT-POINT | ATM | - | False |

##### IPv4

| Interface | VRF | IP Address | IP Address Virtual | IP Router Virtual Address | ACL In | ACL Out |
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan1115 |  ETHERNET_VPN  |  -  |  10.1.5.1/24  |  -  |  -  |  -  |
| Vlan1205 |  ATM  |  -  |  10.2.1.1/24  |  -  |  -  |  -  |
...
!
interface Vlan1115
   description SVC01_C1_VLAN_SITE02_PE01
   no shutdown
   vrf ETHERNET_VPN
   ip address virtual 10.1.5.1/24
!
interface Vlan1205
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0102.5500.1005.00 |
| Type | level-2 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 1115 | 10.255.1.5:11115 | 11115:11115 | - | - | learned |
| 1205 | 10.255.1.5:13205 | 13205:13205 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| ATM | 10.255.1.5:12 | connected |
| ETHERNET_VPN | 10.255.1.5:11 | connected |
...
router bgp 65000
   ...
   vrf ATM
      ...
      router-id 10.255.1.5
      neighbor 10.2.1.21 peer group ATM-BACKBONE
      neighbor 10.2.1.21 remote-as 65102
      neighbor 10.2.1.21 description ATM CONNECTITVITY S2-CE01
      redistribute connected
      !
      address-family ipv4
         neighbor 10.2.1.21 activate
   !
   vrf ETHERNET_VPN
      rd 10.255.1.5:11

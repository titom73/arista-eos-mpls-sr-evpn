...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.2.21/24 | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | ROUTER_s2-ce01_eth1 | trunk | 1018 | - | - | - |
...
| Loopback1810 | Test loopback | SVC01_VRF01 | 10.18.0.5/32 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 1811 | 10.255.1.5:11811 | 11811:11811 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| SVC01_VRF01 | 10.255.1.5:10 | connected |
...
router bgp 73.1
   ...
   neighbor MPLS-OVERLAY-PEERS remote-as 73.1

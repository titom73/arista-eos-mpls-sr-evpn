...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 1205 | 10.255.1.5 | enabled | Vlan1205 <br> | disabled | default | disabled | disabled | - | - | - | - |
...
| --- | ------------------- | ------------ |
| ATM | 10.255.1.5:12 | connected<br>ospf |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list PL-ATM-FAKE-PREFIX | tag 1205 | - | - |

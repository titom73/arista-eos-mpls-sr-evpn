...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4 | to s1-ce01 - firewall test - vrrp | switched | trunk | 1810 | - | - | - | - | - | 0000:0000:0101:0101:0101 |
...
| Loopback1018 | Router ID | CLIENTS | 1.18.10.11/32 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan1810 |  CLIENTS  |  10.18.10.11/24  |  -  |  10.18.10.1  |  -  |  -  |  -  |
...
| --- | ------------------- | ------------ |
| CLIENTS | 1.0.0.11:1 | static<br>connected |

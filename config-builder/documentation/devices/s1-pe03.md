...
| ------- | ---- | ------------ |
| 1113 | SVC01_C1_VLAN_SITE01_PE03 | - |
...
| Loopback1011 | SVC_ETHERNET_LOOPBACK | ETHERNET_VPN | 10.1.255.3/32 |
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan1113 | SVC01_C1_VLAN_SITE01_PE03 | ETHERNET_VPN | - | False |

##### IPv4

| Interface | VRF | IP Address | IP Address Virtual | IP Router Virtual Address | ACL In | ACL Out |
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan1113 |  ETHERNET_VPN  |  -  |  10.1.3.1/24  |  -  |  -  |  -  |
...
!
interface Vlan1113
   description SVC01_C1_VLAN_SITE01_PE03
   no shutdown
   vrf ETHERNET_VPN
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 1113 | 10.255.1.3:11113 | 11113:11113 | - | - | learned |
...
| ETHERNET_VPN | 10.255.1.3:11 | connected |

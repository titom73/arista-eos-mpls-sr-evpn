...
| Loopback1001 | SVC_ETHERNET_LOOPBACK | ETHERNET_VPN | 10.1.255.3/32 |
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan1013 | SVC01_C1_VLAN_SITE01_PE03 | ETHERNET_VPN | - | False |

##### IPv4

| Interface | VRF | IP Address | IP Address Virtual | IP Router Virtual Address | ACL In | ACL Out |
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan1013 |  ETHERNET_VPN  |  -  |  10.1.3.1/24  |  -  |  -  |  -  |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 1013 | 10.255.1.3:11013 | 11013:11013 | - | - | learned |

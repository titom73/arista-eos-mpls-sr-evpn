...
| Loopback1018 | Router ID | FW-HA | 1.18.10.13/32 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan1810 |  FW-HA  |  10.18.10.13/24  |  -  |  10.18.10.1  |  -  |  -  |  -  |
...
| --- | ------------------- | ------------ |
| BKP | 1.0.0.13:2 | static<br>connected |
| FW-HA | 1.0.0.13:1 | static<br>connected |
